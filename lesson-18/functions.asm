...
; Note: every syscall here isn't called explicitley, but through the 'syscall' function, which makes sure that all the registers syscall may change (rcx and r11) are automatically restored

; void syscall()
; Perform syscall without data loss function
syscall:
        push    rcx
        push    r11     ; save all possibly changed registers
        syscall
        pop     r11
        pop     rcx     ; restore all possibly changed registers
        ret
